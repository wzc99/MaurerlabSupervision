package sys.spvisor.core.common;
...
import sys.spvisor.core.util.DateTypeEditor;
 ...
 * @author dazhou<9iuorg@gmail.com>
 * @version 2013-03-19 11:08:15
 * @see com.dazhou.frame.controller.BaseController
 * @param <T>
 */
// @Controller
public class BaseController extends BaseLogger {
	...
	public void initBinder(WebDataBinder binder) {
		 ...
		 * (StringUtils.isNotBlank(value)) { try { setValue(new
		 * SimpleDateFormat(DateUtils.DATETIME_FORMAT).parse(value)); } catch
		 * (Exception e) { setValue(new
	 ...
	 * @return
	 */
	public Page newPage(HttpServletRequest request, int totalCount) {
		// ==获取分页信息
		return newPage(request, "id", "desc", totalCount);
	}
	 ...
	 * @return
	 */
	public Page newPage(HttpServletRequest request, String defaultOrder, String defaultSort, int totalCount) {
		// ==获取分页信息
		...
		int pageSize = NumberUtils.toInt(str_pageSize, 20);
