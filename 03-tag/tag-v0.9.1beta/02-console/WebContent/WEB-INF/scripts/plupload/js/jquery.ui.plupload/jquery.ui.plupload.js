			...
			'<div class="ui-widget-content plupload_container">' +
				'<div class="ui-state-default ui-widget-header plupload_header">' +
					'<div class="plupload_header_content">' +
						...
						'<div class="plupload_header_title">' + _("资质及附件") + '</div>' +
						'<div class="plupload_header_text">' + _("将文件添加到上传队列，然后点击开始按钮.") + '</div>' +
				...
				'<tr>' +
					...
					'<td class="plupload_cell plupload_file_status">' + _('进度') + '</td>' +
	...
	*/
	...
	_handleState: function() {
		...
		if (up.total.queued === 0) {
			...
			$('.ui-button-text', this.browse_button).html(o.sprintf(_('%d 个文件加入到队列'), up.total.queued));
		}
